...
class ChikkaController extends Controller{
    ...
    public function send() {
        //$to = Input::post('mobile_number');
        //$message = Input::post('message');
        $messageID = str_random(32);
        $to = '639425341739';
        $message = 'Also dli pako kalakaw kay nagwait kos conference call';
    ...
    public function receive() {
        ...
        {
            if(isset($_POST['message']) && isset($_POST['mobile_number']) && isset($_POST['shortcode']) && isset($_POST['timestamp'] && isset($_POST['request_id']))){
                ...
                json_encode(array('message' => 'Accepted'));
            }else{
            json_encode(array('message' => 'error'));
            }
        }else{
